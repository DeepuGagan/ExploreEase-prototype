    ...
    <>
      {
        Array(8).fill('item').map((item, index) => {
          return (
            <div
              key={index}
              className="bg-white p-2 w-80  sm:w-full sm:p-4 h-auto sm:h-64 rounded-2xl shadow-lg flex flex-col sm:flex-row gap-5 select-none"
            >
              {/* <div
        className="h-52 sm:h-full sm:w-72 rounded-xl bg-gray-100 bg-center bg-cover"
        style={{
          background: 'url("https://source.unsplash.com/man-skiing-on-land-Pf6e3o0GL4M")'
        }}
      /> */}
              <div className="transform transition-transform duration-500 ease-in-out hover:scale-110"> 
                <img
                  alt=""
                  className="h-52 sm:h-full sm:w-72 rounded-xl "
                  src="https://images.unsplash.com/photo-1551524559-8af4e6624178?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8c2tpaW5nfGVufDB8MHwwfHx8MA%3D%3D"
                />
              </div>
