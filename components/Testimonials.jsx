...
const Testimonials = () => {
  ...
  return (
    <section className="bg-transparent">
      <div className="mx-auto w-[1400px] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 ">
        <h2 className="text-center text-4xl font-medium tracking-tight text-gray-900 sm:text-5xl">
          Read trusted reviews from our customers
        </h2>

        <div className="mt-8 [column-fill:_balance] sm:columns-2 sm:gap-6 lg:columns-3 lg:gap-8">
          <div className="mb-8 sm:break-inside-avoid hover:scale-105">
            <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8 drop-shadow-lg hover:drop-shadow-2xl">
