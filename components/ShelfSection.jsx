...
import '@/styles/shelfSection.css'

const ShelfSection = () => {
    const CardList = [{
        location: 'Rome, Italy',
        name: 'Vatican Museums, Sistine Chapel &amp; St Peter’s Basilica Guided Tour',
        img: 'https://media.tacdn.com/media/attractions-splice-spp-360x240/0f/ba/c1/d8.jpg',
        likes: '32,265',
        price:'₹6,810.47'
    },
    {
        ...
        <div className='shelf_container'>
            <div className='container'>
                <div className='titleBox'>
                    <h2 className='title' style={{ alignContent: 'center' }}>Top Tours</h2>
                </div>
                <div className='card'>
                    {CardList.map((items, index) => (
                        <div className='content'>
                            ...
                            <div className='textBlock' >
                                ...
                                <strong className='link' style={{ fontSize: '15px' }}>
                                    {items.name}
                                </strong>
