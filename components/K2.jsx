...
const K2 = () => {
  return (
    <div className='bg-gradient-to-tr from-cyan-200  via-cyan-100  to-blue-200'>
        ...
        <div className="flex flex-grow px-10 mt-4 space-x-6 overflow-auto mx-auto">
            ...
            <div className="flex flex-col pb-2">
              ...
              {/* <div className='border-l-4 border-blue-600 relative flex flex-row items-start px-2 py-1 mt-3 bg-white rounded-r-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100'>
                <div className=' w-1/3 my-auto mr-2'>
                  <img src="https://plus.unsplash.com/premium_photo-1666432045829-1baa60b1e597" alt="par" className='h-28 rounded-xl object-cover' />
                </div>
                <div>
              ...
              {/* <div className='border-l-4 border-indigo-500 relative flex flex-col items-start px-1 py-1 mt-3 bg-white rounded-r-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100'>
                ...
                <div className='w-full flex items-center justify-center'>
                  <img src="https://plus.unsplash.com/premium_photo-1666432045829-1baa60b1e597" alt="par" className='h-36 w-[270px] rounded-xl object-cover' />
                </div>
              ...
              <div className='relative flex flex-col items-start p-2 mt-3 bg-orange-200 rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100'>
              ...
              <div className='border-l-4 border-indigo-500 relative flex flex-row items-start px-2 py-1 mt-3 bg-white rounded-r-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100'>
                ...
                <div>
                  <Chip size="sm" color="info" className='scale-75'>Attraction</Chip>
              ...
              <div className='border-l-4 border-indigo-500 relative flex flex-col items-start px-1 py-1 mt-3 bg-white rounded-r-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100'>
                <Chip size="sm" color="info" className='scale-75'>Accomodation</Chip>
                <div className='w-full flex items-center justify-center'>
          ...
          <div className="flex flex-col flex-shrink-0 w-72">
            ...
            <div className="flex flex-col pb-2">
              ...
              <div className='border-l-4 border-indigo-500 relative flex flex-col items-start px-1 py-1 mt-3 bg-white rounded-r-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100'>
                <Chip size="sm" color="info" className='scale-75'>Entertainment</Chip>
                <div className='w-full flex items-center justify-center'>
          ...
          <div className="flex flex-col flex-shrink-0 w-72">
            ...
            <div className="flex flex-col pb-2">
              ...
              <div className='border-l-4 border-indigo-500 relative flex flex-row items-start px-2 py-1 mt-3 bg-white rounded-r-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100'>
                ...
                <div>
                  <Chip size="sm" color="info" className='scale-75'>Events</Chip>
              ...
              <div className='border-l-4 border-indigo-500 relative flex flex-col items-start px-1 py-1 mt-3 bg-white rounded-r-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100'>
                <Chip size="sm" color="info" className='scale-75'>Event</Chip>
                <div className='w-full flex items-center justify-center'>
          ...
          <div className="flex flex-col flex-shrink-0 w-72">
            ...
            <div className="flex flex-col pb-2">
              ...
              <div className='border-l-4 border-indigo-500 relative flex flex-row items-start px-2 py-1 mt-3 bg-white rounded-r-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100'>
                <div className=' w-1/3 my-auto mr-2'>
                  <img src="https://images.unsplash.com/photo-1539481915544-f5cd50562d66" alt="par" className='h-28 rounded-xl object-fill' />
                </div>
                <div>
                  <Chip size="sm" color="info" className='scale-75'>Event</Chip>
              ...
              <div className='border-l-4 border-indigo-500 relative flex flex-row items-start px-2 py-1 mt-3 bg-white rounded-r-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100'>
                ...
                <div>
                  ...
                  <p className='text-xs font-thin' >&#128343; 3hr</p>
                  <div className='flex flex-row gap-4 justify-between'>
                    <p className='text-sm font-medium content-center flex-start'>$ 65</p>
