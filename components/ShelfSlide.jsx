                    ...
                    {CardList.map((items, index) => (
                        ...
                        <div className='contentSS' >
                            <div className='imageSS'>
                                <img className='inImage' src={items.img} style={{ borderRadius: '12px',marginBottom:'15px'}}></img>
                            </div>
                          
                            <div className='textBlock' >
                                <div className='location' style={{ display: 'flex', marginBottom: '15px' }}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" className="icon_location">
                                ...
                                <div className='star' style={{ display: 'flex' }}>
                                    {Array(5).fill().map((_, index) => (
                                        <p key={index} className='star' style={{ color: '#FED141', marginLeft: '2px' }}>&#x2605;</p>
                                    ))}
