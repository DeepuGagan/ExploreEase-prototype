...
const LatestStories2 = () => {
  return (
    <section className="relative my-12 md:mt-20">
      <section className="jsx-f704f42be0b5c3bb max-w-full mx-4 my-16 articles lg:my-24 md:mx-auto md:container cursor-default-hover">
        <div className="jsx-f704f42be0b5c3bb cursor-default-hover">
          <h2
          ...
          <header className="jsx-f704f42be0b5c3bb flex items-end justify-between mt-5 mb-10 lg:mt-8 lg:mb-14 cursor-default-hover">
          ...
          <div className="jsx-f704f42be0b5c3bb mb-8 lg:w-3/5 lg:shrink-0 lg:mb-auto">
            <div className="relative">
              ...
              <div className="relative lg:rounded overflow-hidden lg:h-[688px]">
                <img
                  alt="LOCAL FLAVOR FL panhandle - TitleThe Daytrader Tiki Bar & Restaurant"
                  className="max-w-full hidden object-cover w-full h-full rounded -z-10 lg:block"
                  data-nimg="1"
                  decoding="async"
                  height="630"
                  loading="lazy"
                  src="https://lp-cms-production.imgix.net/2024-05/Local-Flavor-Panhandle-feature.png?auto=format&w=730&h=630&fit=crop&q=75"
                  srcSet="https://lp-cms-production.imgix.net/2024-05/Local-Flavor-Panhandle-feature.png?auto=format&w=730&h=630&fit=crop&q=75 1x, https://lp-cms-production.imgix.net/2024-05/Local-Flavor-Panhandle-feature.png?auto=format&w=730&h=630&fit=crop&q=75 2x"
                  style={{
                    color: 'transparent'
                  }}
                  width="730"
                ...
                <img
                  ...
                  height="425"
                  loading="lazy"
                  src="https://lp-cms-production.imgix.net/2024-05/Local-Flavor-Panhandle-feature.png?auto=format&w=780&h=425&fit=crop&q=75"
                  srcSet="https://lp-cms-production.imgix.net/2024-05/Local-Flavor-Panhandle-feature.png?auto=format&w=780&h=425&fit=crop&q=75 1x, https://lp-cms-production.imgix.net/2024-05/Local-Flavor-Panhandle-feature.png?auto=format&w=780&h=425&fit=crop&q=75 2x"
                  style={{
                    color: 'transparent'
                  }}
                  width="780"
                ...
                <div className="top-0 flex items-end w-full h-full pt-4 lg:absolute lg:bg-gradient-to-t from-transparent-80 via-transparent-40 to-transparent lg:p-8">
                  <div className="lg:w-2/3 lg:pb-8">
                    <p className="relative z-10 uppercase label-sm text-black-400 lg:text-white cursor-default-hover">
                      Food and Drink
                    </p>
                    <a
                      className="inline-block my-2 font-semibold card-link heading-04 lg:text-white cursor-on-hover"
                      href="/articles/food-drink-florida-panhandle"
                    >
                      Local Flavor: where to eat and drink on the Florida Panhandle
                    </a>
                    <p className="relative text-black-400 lg:text-white cursor-default-hover">
                      May 20, 2024 • 7 min read
                    </p>
                    <p className="relative hidden mt-4 lg:block lg:text-white cursor-default-hover">
                      A bona fide culinary scene is heating up along the Gulf. Here's where to go — and what to avoid — on the Florida Panhandle.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="jsx-f704f42be0b5c3bb flex flex-col gap-y-4 lg:h-full">
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          alt="Dramatic view of the Grossglockner, seen from the Kaiser-Franz-Josefs-Höhe in the national wildpark in Tyrol, Austria. Partially snow covered mountains, shot against a partially clouded sky. ; Shutterstock ID 1122269903; GL: 65050; netsuite: Online ed; full: austria road trips; name: Claire N1122269903"
                          className="max-w-full object-cover w-full h-full aspect-square"
                          data-nimg="1"
                          decoding="async"
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2024-05/shutterstock1122269903-1.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2024-05/shutterstock1122269903-1.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3 cursor-on-hover"
                          href="/articles/best-road-trips-in-austria"
                        >
                  ...
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          alt="Photo taken in Spanish Town, Jamaica"
                          className="max-w-full object-cover w-full h-full aspect-square"
                          data-nimg="1"
                          decoding="async"
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2022-09/Jamaica-Spanish-Town-JhenelleHudson-GettyImages-1296331069-RFC.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2022-09/Jamaica-Spanish-Town-JhenelleHudson-GettyImages-1296331069-RFC.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3 cursor-on-hover"
                          href="/articles/best-places-to-visit-in-jamaica"
                        >
                  ...
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          alt="JULY 10, 2015: Crowd of revelers in front of the main stage at EXIT 2015 Music Festival during a set by heavy metal band Motorhead.356050244popular, exit, fun, roll, heavy, serbia, rock, music, sing, european, sound, show, night, gig, fans, summer, outside, event, guitar, celebrity, best, performer, entertainment, famous, festival, concert, loud, crowd, live, europe, bassist, metal, largest, performance, vojvodina, petrovaradin, motörhead, motorhead, peaple, 2015, outdoor, sad, kilmister, main, novi, stage, lemmy, girl, on shoulders"
                          className="max-w-full object-cover w-full h-full aspect-square"
                          data-nimg="1"
                          decoding="async"
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2024-05/shutterstockRF356050244.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2024-05/shutterstockRF356050244.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        <div className="text-sm uppercase font-semibold tracking-wide relative z-10 mb-2 w-90 text-black-400 block cursor-default-hover">
                          Festivals & Events
                        </div>
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/how-to-pack-for-any-festival"
                        >
                  ...
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          alt="English garden and Munich skyline panoramic view; Shutterstock ID 1537783262; GL: 65050; netsuite: Online ed; full: Munich neighborhoods; name: Claire N1537783262"
                          className="max-w-full object-cover w-full h-full aspect-square"
                          data-nimg="1"
                          decoding="async"
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2024-05/shutterstock1537783262.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2024-05/shutterstock1537783262.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/best-neighborhoods-in-munich"
                        >
                          7 of the best neighborhoods in Munich
                        </a>
                        <p className="text-sm text-black-400">
                ...
                <div className="jsx-f704f42be0b5c3bb flex flex-col gap-y-4 lg:h-full">
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          alt="Overlooking view of the Lake Konigssee from Jenner peak, Berchtesgaden, Germany.579469138trekking trail"
                          className="max-w-full object-cover w-full h-full aspect-square"
                          data-nimg="1"
                          decoding="async"
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2024-05/GettyRF579469138.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2024-05/GettyRF579469138.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/best-day-trips-from-munich"
                        >
                          10 of the best day trips from Munich: nature, culture, and fairy-tale castles
                        </a>
                        <p className="text-sm text-black-400">
                  ...
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          alt="A girl sits on the shore of Lake Louise in Banff National Park in the Rocky Mountains.630322607alberta, autumn, banff, beautiful, blue, calm, canada, charming, clean, cloud, cold, destination, environment, flower, forest, glacial, green, hike, inspiring, lake, landscape, louise, mountain, national, nature, outdoor, park, peaceful, peak, quiet, reflections, rocky, scenery, season, sightseeing, sky, snowing, summer, toutism, travel, trees, unusual, valley, vintage, water, wide, wild, wildlife, wind, winter"
                          className="max-w-full object-cover w-full h-full aspect-square"
                          data-nimg="1"
                          decoding="async"
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2024-05/shutterstockRF630322607.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2024-05/shutterstockRF630322607.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/best-national-parks-canada"
                        >
                  ...
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/getting-around-france"
                        >
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          ...
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2024-05/LPT0913009.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2024-05/LPT0913009.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/best-road-trips-france"
                        >
                ...
                <div className="jsx-f704f42be0b5c3bb flex flex-col gap-y-4 lg:h-full">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          ...
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2024-05/GettyImages-1409535695.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2024-05/GettyImages-1409535695.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/portugal-for-everyone"
                        >
                  ...
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          alt="TBF-20190620-7633TEV.jpg"
                          className="max-w-full object-cover w-full h-full aspect-square"
                          data-nimg="1"
                          decoding="async"
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2023-04/TBF-20190620-7633TEV.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2023-04/TBF-20190620-7633TEV.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/us-music-festivals-to-travel-for"
                        >
                  ...
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          alt="Tampa Bay, Florida. March 02, 2019 People walking at riverwalk in downtown area  (1); Shutterstock ID 1358646137; GL: 65050; netsuite: Online Editorial; full: Weekend in Tampa; name: Bailey Freeman1358646137Tampa Bay, Florida. March 02, 2019 People walking at riverwalk in downtown area"
                          className="max-w-full object-cover w-full h-full aspect-square"
                          data-nimg="1"
                          decoding="async"
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2024-05/shutterstockeditorial1358646137.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2024-05/shutterstockeditorial1358646137.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/ultimate-weekend-in-tampa"
                        >
                          The ultimate weekend in Tampa, Florida
                        </a>
                        <p className="text-sm text-black-400">
                          May 17, 2024 • 6 min read
                        </p>
                  ...
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          alt="Italy - Tuscany and Umbria Great escape July 2014....Casteluccio- hill top town known for its lentilsItaly - Tuscany and Umbria Great escape July 2014..Casteluccio- hill top town known for its lentilsContributor, LP Owned, Countryside, Field, Grassland, Landscape, Meadow, Mountain, Mountain Range, Nature, Outdoors, Plateau, Rural, Scenery"
                          className="max-w-full object-cover w-full h-full aspect-square"
                          data-nimg="1"
                          decoding="async"
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2024-05/LPT0515083-16.9.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2024-05/LPT0515083-16.9.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/best-places-to-see-flowers"
                        >
                ...
                <div className="jsx-f704f42be0b5c3bb flex flex-col gap-y-4 lg:h-full">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          ...
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2024-05/shutterstock349835384-cropped.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2024-05/shutterstock349835384-cropped.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/libraries-visit-usa"
                        >
                  ...
                  <div className="relative">
                    ...
                    <article className="relative flex items-center rounded-md h-full p-4 hover:shadow-md focus:shadow-md md:my-6 bg-[#F0F7FC] border border-[#E0EEFA] md:my-auto lg:h-[160px]">
                      <div className="flex-none mr-4 md:mr-6 rounded-md overflow-hidden w-1/5">
                        <img
                          alt="A hiker looking down a rocky valley on Gros Morne Mountain Hiking Trail.500px Photo ID: 129542151newfoundland, adventure, autumn, backpacking, beautiful, canada, fall, gros morne, hiking, mountains, national park, nature, outdoors, park, scree, travel, man in environment, dorian, tsai, wanderlust"
                          className="max-w-full object-cover w-full h-full aspect-square"
                          data-nimg="1"
                          decoding="async"
                          height="140"
                          loading="lazy"
                          src="https://lp-cms-production.imgix.net/2023-06/500pxRF129542151.jpg?auto=format&w=140&h=140&fit=crop&q=75"
                          srcSet="https://lp-cms-production.imgix.net/2023-06/500pxRF129542151.jpg?auto=format&w=140&h=140&fit=crop&q=75 1x"
                          style={{
                            color: 'transparent'
                          }}
                          width="140"
                      ...
                      <div className="flex-auto w-0">
                        ...
                        <a
                          className="lg:text-lg text-black hover:text-black font-semibold card-link mb-1 line-clamp-3"
                          href="/articles/guide-to-newfoundland"
                        >
