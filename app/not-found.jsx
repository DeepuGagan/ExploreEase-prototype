    ...
    <div>
      <div className="w-full h-screen flex flex-col items-center justify-between">
        <div className="xl:w-1/2 flex-1 flex flex-col items-center justify-center text-center px-4 lg:px-0">
          ...
          <p className="text-3xl font-bold text-black-200 capitalize tracking-wide mt-8">
            Hold up! this page is still under deveploment.
          </p>
          <p className="text-lg text-slate-300 uppercase mt-4">
